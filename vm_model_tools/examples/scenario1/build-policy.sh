...
function do-make-policy() {
    ...
    if [[ $DEPLOYED_ENCLAVE_TYPE = "sev-enclave" ]]; then
        ...
        $CERTIFIER_ROOT/utilities/make_indirect_vse_clause.exe \
          ...
          --verb="says" \
          --clause=sev_ts1.bin \
          --output=sev_vse_policy1.bin

        $CERTIFIER_ROOT/utilities/make_signed_claim_from_vse_clause.exe \
          --vse_file=sev_vse_policy1.bin \
          --duration=9000 \
          --private_key_file=$POLICY_KEY_FILE_NAME \
          --output=sev_signed_claim_1.bin

        if [[ $TEST_TYPE = "simulated" ]]; then
          $CERTIFIER_ROOT/utilities/make_unary_vse_clause.exe \
             --key_subject="" \
             --measurement_subject=sev_cf_utility.measurement \
             --verb="is-trusted" \
             --output=sev_ts2.bin
        else
          $CERTIFIER_ROOT/utilities/make_unary_vse_clause.exe \
             --key_subject="" \
             --measurement_subject=Pauls_vm.measurement \
             --verb="is-trusted" \
             --output=sev_ts2.bin
        fi
        ...
        $CERTIFIER_ROOT/utilities/make_indirect_vse_clause.exe \
          ...
          --verb="says" \
          --clause=sev_ts2.bin \
          --output=sev_vse_policy2.bin

        $CERTIFIER_ROOT/utilities/make_signed_claim_from_vse_clause.exe \
          --vse_file=sev_vse_policy2.bin \
          --duration=9000 \
          --private_key_file=$POLICY_KEY_FILE_NAME \
          --output=sev_signed_claim_2.bin
        ...
        $CERTIFIER_ROOT/utilities/make_platform.exe \
          ...
          --properties_file=sev_properties.bin \
          --output=sev_platform.bin

        $CERTIFIER_ROOT/utilities/make_unary_vse_clause.exe \
          --platform_subject=sev_platform.bin \
        ...
        $CERTIFIER_ROOT/utilities/make_indirect_vse_clause.exe \
          ...
          --verb="says" \
          --clause=sev_ts3.bin \
          --output=sev_vse_policy3.bin

        $CERTIFIER_ROOT/utilities/make_signed_claim_from_vse_clause.exe \
          --vse_file=sev_vse_policy3.bin \
          --duration=9000 \
          --private_key_file=$POLICY_KEY_FILE_NAME \
          --output=sev_signed_claim_3.bin
