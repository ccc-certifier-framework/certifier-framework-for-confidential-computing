...
if [[ $TEST_TYPE = "simulated" ]]; then
	...
	ALLSIMARG5="-vmn pauls_vm -et1 simulated-enclave -et2 sev-enclave"
	ALLSIMARG6="-dd1 $DEPLOYMENT_DATA_DIR -dd2 $DEPLOYED_DATA_DIR -psn1 $DEPLOYMENT_POLICY_STORE_NAME"
	ALLSIMARG7="-psn2 $DEPLOYED_POLICY_STORE_NAME -csn1 $DEPLOYMENT_CRYPTSTORE_NAME -csn2 $DEPLOYED_CRYPTSTORE_NAME"

	ALLARGS="$ALLSIMARG1 $ALLSIMARG2 $ALLSIMARG3 $ALLSIMARG4 $ALLSIMARG5 ALLSIMARG6 ALLSIMARG7"
else
