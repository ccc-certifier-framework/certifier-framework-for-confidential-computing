...
bool construct_sev_platform_evidence(
  ...
  if (ev ==nullptr) {
    printf("construct_sev_platform_evidence: Can't add to ark platform evidence\n");
    return false;
  }
  ...
  if (ev ==nullptr) {
    printf("construct_sev_platform_evidence: Can't add to ask platform evidence\n");
    return false;
  }
  ev->set_evidence_type("cert");
  ...
  ev = evp->add_fact_assertion();
  if (ev ==nullptr) {
    printf("construct_sev_platform_evidence: Can't add to vcek platform evidence\n");
    return false;
  }
  ev->set_evidence_type("cert");
  ...
  if (purpose == "authentication") {
    ...
    printf("construct_sev_platform_evidence: neither attestation or authorization\n");
    return false;
  }
