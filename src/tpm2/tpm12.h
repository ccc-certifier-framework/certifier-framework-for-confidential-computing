...
#define TPM_Vendor_Specific8        ((byte) 0x80)
...
typedef struct tdTPM_PERMANENT_FLAGS{
  ...
  byte                           deactivated;
  byte                           readPubek;
  byte                           disableOwnerClear;
  byte                           allowMaintenance;
  byte                           physicalPresenceLifetimeLock;
  byte                           physicalPresenceHWEnable;
  byte                           physicalPresenceCMDEnable;
  byte                           CEKPUsed;
  byte                           TPMpost;
  byte                           TPMpostLock;
  byte                           FIPS;
  ...
  byte                           readSRKPub;
  byte                           tpmEstablished;
  byte                           maintenanceDone;
  byte                           disableFullDALogicInfo;
} TPM_PERMANENT_FLAGS;
...
typedef struct tdTPM_STCLEAR_FLAGS{
  ...
  byte                           physicalPresence;
  byte                           physicalPresenceLock;
  byte                           bGlobalLock;
} TPM_STCLEAR_FLAGS;
...
#define TPM_LOC_FOUR                ((byte) 0x10)
#define TPM_LOC_THREE               ((byte) 0x08)
#define TPM_LOC_TWO                 ((byte) 0x04)
#define TPM_LOC_ONE                 ((byte) 0x02)
#define TPM_LOC_ZERO                ((byte) 0x01)
...
typedef struct tdTPM_MIGRATE_ASYMKEY {              // pos  len  total
  ...
  byte                             *partPrivKey;   //  45 112-127 157-172
} TPM_MIGRATE_ASYMKEY;
...
//
#define TPM_DA_STATE_INACTIVE          ((byte)0x00)
#define TPM_DA_STATE_ACTIVE            ((byte)0x01)
