...
#define TPM_ET_KEYHANDLE            ((uint16_t) 0x0001) ///< The entity is a keyHandle or key
...
#define TPM_ET_REVOKE               ((uint16_t) 0x0006) ///< The entity is the RevokeTrust value
#define TPM_ET_DEL_OWNER_BLOB       ((uint16_t) 0x0007) ///< The entity is a delegate owner blob
#define TPM_ET_DEL_ROW              ((uint16_t) 0x0008) ///< The entity is a delegate row
#define TPM_ET_DEL_KEY_BLOB         ((uint16_t) 0x0009) ///< The entity is a delegate key blob
...
#define TPM_ET_RESERVED_HANDLE      ((uint16_t) 0x0040) ///< Reserved. This value avoids collisions with the handle MSB setting.
...
#define TPM_ET_AES128               ((uint16_t) 0x0006) ///< ADIP encryption scheme: AES 128 bits
