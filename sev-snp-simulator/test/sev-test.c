...
static bool digest_sha384(const void *msg, size_t msg_len, uint8_t *digest, size_t digest_len)
{
	bool ret = false;
...
int main(int argc, char *argv[])
{
	...
	opt.svn = 1;
	opt.fields = FIELD_POLICY_MASK |
		FIELD_IMAGE_ID_MASK |
		FIELD_FAMILY_ID_MASK |
		FIELD_MEASUREMENT_MASK |
		FIELD_GUEST_SVN_MASK |
