...
dobj_new= $(O)/app_service_new.o $(O)/certifier.pb.o $(O)/certifier.o $(O)/support.o \
$(O)/simulated_enclave.o $(O)/application_enclave.o $(O)/cc_helpers.o


all:	app_service.exe hello_world.exe send_request.exe test_user.exe app_service_new.exe 
...
app_service_new.exe: $(dobj_new)
	@echo "linking executable files"
	$(LINK) -o $(EXE_DIR)/app_service_new.exe $(dobj_new) $(LDFLAGS)
...
$(O)/app_service_new.o: $(S)/app_service_new.cc $(S)/certifier.pb.cc
	@echo "compiling app_service_new.cc"
	$(CC) $(CFLAGS) -c -o $(O)/app_service_new.o $(S)/app_service_new.cc
...
$(O)/cc_helpers.o: $(LIBSRC)/cc_helpers.cc $(I)/certifier.h $(S)/certifier.pb.cc
