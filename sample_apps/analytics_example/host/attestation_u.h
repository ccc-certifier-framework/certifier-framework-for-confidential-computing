...
/**** ECALL prototypes. ****/
oe_result_t certifier_init(
    oe_enclave_t* enclave,
    bool* _retval,
    const void* data_dir,
    size_t size);

oe_result_t openenclave_init(
    oe_enclave_t* enclave,
    bool* _retval);

oe_result_t cold_init(
    oe_enclave_t* enclave,
    bool* _retval);

oe_result_t certify_me(
    oe_enclave_t* enclave,
    bool* _retval);

oe_result_t warm_restart(
    oe_enclave_t* enclave,
    bool* _retval);

oe_result_t run_me_as_client(
    oe_enclave_t* enclave,
    bool* _retval);

oe_result_t run_me_as_server(
    oe_enclave_t* enclave,
    bool* _retval);

oe_result_t temp_test(
    oe_enclave_t* enclave,
    bool* _retval);
