#    
#    File: sev_example_app_with_service.mak
...
dobj=	$(O)/sev_example_app_with_service.o $(O)/certifier.pb.o $(O)/certifier.o $(O)/support.o \
$(O)/application_enclave.o $(O)/simulated_enclave.o  $(O)/sev_support.o \
$(O)/sev_report.o $(O)/cc_helpers.o


all:	sev_example_app_with_service.exe
clean:
	@echo "removing object files"
	rm $(O)/*.o
	@echo "removing executable file"
	rm $(EXE_DIR)/sev_example_app_with_service.exe

sev_example_app_with_service.exe: $(dobj) 
	@echo "linking executable files"
	$(LINK) -o $(EXE_DIR)/sev_example_app_with_service.exe $(dobj) $(LDFLAGS)
...
$(O)/sev_example_app_with_service.o: $(US)/sev_example_app_with_service.cc $(I)/certifier.h $(US)/certifier.pb.cc
	@echo "compiling sev_example_app_with_service.cc"
	$(CC) $(CFLAGS) -c -o $(O)/sev_example_app_with_service.o $(US)/sev_example_app_with_service.cc
