#
#    File: tpm_example_app_new_api.mak
...
US=.
I= $(SRC_DIR)/include
INCLUDE=-I. -I $(I) -I/usr/local/opt/openssl@1.1/include/ -I $(S)/tpm2 -I/usr/include
...
dobj = $(O)/tpm_example_app.o $(O)/certifier.pb.o $(O)/certifier.o \
...
clean:
	...
	rm -rf $(EXE_DIR)/tpm_example_app.exe

$(EXE_DIR)/tpm_example_app.exe: $(dobj)
	@echo "\nlinking executable $@"
