...
extern bool gramine_remote_verify_impl(
    const int what_to_say_size, byte* what_to_say, const int attestation_size,
...
bool graminelib_Verify(const int what_to_say_size, byte* what_to_say,
  ...
  result = gramine_remote_verify_impl(what_to_say_size, what_to_say,
