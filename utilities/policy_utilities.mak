...
$(O)/simulated_enclave.o: $(SE)/simulated_enclave.cc $(INC_DIR)/simulated_enclave.h
	@echo "\ncompiling $<"
	$(CC) $(CFLAGS) -o $(@D)/$@ -c $<

$(O)/application_enclave.o: $(AE)/application_enclave.cc $(INC_DIR)/application_enclave.h
	@echo "\ncompiling $<"
	$(CC) $(CFLAGS) -o $(@D)/$@ -c $<
